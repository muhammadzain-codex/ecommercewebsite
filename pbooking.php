...
?>			<!-- start page content -->
				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Pending Booking List</div>
							</div>
            ...
            $cart=mysqli_query($con,"SELECT * from bookings where status='0' ");
 ...
 <td scope="row"><?php echo $urow['id']?></td>
  ...
  <td scope="row"><?php echo $urow['phone']?></td>
              ...
              <td class="text-success"> 
              	...
              	<a href="acceptbooking.php?bid=<?php echo $row['id']?>&email=<?php echo $urow['email']?>"class="btn btn-success">ACCEPT BOOKING</a>
              	<a href="declinebooking.php?bid=<?php echo $row['id']?>&email=<?php echo $urow['email']?>" class="btn btn-danger">DECLINE BOOKING</a>
     </td>
