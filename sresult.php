    ...
    <div class="container text-center">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb justify-content-center">
                ...
                <li class="breadcrumb-item active" aria-current="page">Your Search Results</li>
            </ol>
        </nav>
    </div>
</section>
...
$product=mysqli_query($con , "SELECT *FROM products WHERE title like '%$search%' OR psize like '%$search%' OR color like '%$search%' OR price like '%$search%' OR discountprice like '%$search%' OR discription ORDER By id DESC");
