				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Add Categories</div>
							</div>
								...
								<div class="card-body row">
									<div class="col-lg-6 p-t-20">
										<div
											...
											<input class="mdl-textfield__input" name="categorie" type="text" required id="txtDepName">
									...
									<div class="col-lg-12 p-t-20 text-center">
										<button type="submit" name="addcat"
											class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 m-r-20 btn-pink">Add Categories</button></form>
...
if (isset($_POST['addcat'])) {
 ...
 exit();
		 ...
		 mysqli_query($con,"INSERT INTO categories (cname,img) values ('$cate','$target')");
		 echo "<script>alert('Categories added successfully')</script>";
		 echo "<script>window.location='addcategorie.php'</script>";
	 }
